...
#+begin_src emacs-lisp
  ...
  (use-package auto-dark
    ...
    :init (auto-dark-mode))
#+end_src
Of course, we have to change the cursor color now, since loading and applying some themes resets it:
#+begin_src emacs-lisp
  ...
  ;; this is a controversial choice, but it makes it easier to see
  ;; which side of a character you're sitting on. and in modern Emacs,
  ;; it's extremely easy to figure out where your cursor is thanks to the visual
  ;; aids anyways, so...
